...
const float MINIMUM_SPEED   = 2.5f;
const float MAXIMUM_SPEED   = 10.0f;
...
public:
    ...
    void ProcessMouseScroll(float yoffset)
    {
        ...
        float newSpeed = MovementSpeed + (float)yoffset;        

        if ((MINIMUM_SPEED < newSpeed) && (newSpeed < MAXIMUM_SPEED))
        {
